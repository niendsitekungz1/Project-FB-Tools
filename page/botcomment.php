...
<br>
                <div class="col-lg-5" style="float:none;"><button id="start_botcomment" onclick="botcomment();" class="btn btn-outline-success"><i class="fa fa-check fa-lg"></i> เริ่มปั้มคอมเม้นต์</button></div>
