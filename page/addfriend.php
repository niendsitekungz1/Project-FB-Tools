...
<br>
                <div class="col-lg-5" style="float:none;"><button id="start_friend" onclick="addfriend();" class="btn btn-outline-success"><i class="fa fa-check fa-lg"></i> เริ่มปั้มเพื่อน</button></div>
